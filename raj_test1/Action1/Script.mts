...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set DataTable("quan", dtGlobalSheet) @@ script infofile_;_ZIP::ssf8.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("NoOfItem").Highlight
...
Browser("Advantage Shopping").CloseAllTabs @@ hightlight id_;_132000_;_script infofile_;_ZIP::ssf7.xml_;_
